...
export const CardHome  = () =>{
    ...
    <div className="container-fluid row card-info-home">
        <div className="col-12 col-md-6 home-info">
        ...
        <div className="col-12 col-md-6 home-oferta">
            ...
            <p className="text-bienvenida">
                ...
                <img src={imagenOferta} className="imagen-oferta-home start-50" alt="imagen oferta"/>
        </div>
    </div>
    )
