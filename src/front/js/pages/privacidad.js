...
export const Privacidad = () => {
    return (
            ...
            <p className="text-politicas">
                ...
                CIF: B72491202<br/>
                Dirección electrónica: consulta@fisioin.es, poniendo en el Asunto “Protección de datos”.
            </p>
            </article>
    )
}