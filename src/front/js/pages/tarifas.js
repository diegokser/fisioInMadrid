                    ...
                    <div className="tarifas-texto2">
                        <div className="row row-tarifas2">
                            <div className="col-12 col-xl-7">
                                ...
                                <p className="text-tarifas">Utiliza tu cheque servicio de la Comunidad de Madrid con nosotros. Se rige por los precios acordados con la Comunidad de Madrid y siempre cumpliendo el decálogo de derechos de los usuarios:<br/>
