...
const NotFound = () => {
    return (
      <div style={{backgroundColor: "#F4F9FC"}}>
        ...
        <p style={{ textAlign: "center", padding: "3rem", color: "rgb(5,76,132)", fontSize:"1rem"}}>Lo sentimos, la página que buscas no se encuentra disponible en esta dirección. <br />
